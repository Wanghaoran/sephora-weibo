...
//        $this->load->view('creatquestion', $data);
    ...
    public function share_weibo(){
        ...
        $url = 'http://service.weibo.com/share/share.php?url=' . urlencode($this->config->base_url() . 'q/' . $q) . '&type=button&language=zh_cn&appkey=2463278834&title=＃真金犒赏真闺蜜＃' . $question['q'] . $name . '，速速来答题，赢走我的真金犒赏。丝芙兰力挺你家闺蜜！让你们都美哒哒！&pic='  . urlencode($this->config->base_url() . 'public/images/weibo.jpg') .  '&searchPic=false&style=simple';
