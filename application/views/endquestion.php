...
<div class="main">
    <div class="content" id="content" data-q="n" data-style="questioner" data-a="n" data-share="n" onclick="">
        ...
        <section class="screen" id="screen_9">
            ...
            <a class="btn_s9_home btn_common" id="btn_s9_home" href="<?=$this->config->base_url()?>question">出题再抽</a>
            <div class="btn_s9_ques btn_common" id="btn_s9_ques" onclick="location.href='<?=$this->config->base_url()?>share_weibo?q=<?=$q;?>';">分享到微博</div>
